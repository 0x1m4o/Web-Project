        ...
        <div class="row">
            <div class="col-8">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/img/carouseldekor.png" class="d-block w-100" alt="...">
                        </div>
                ...
                <div class="container mt-5 text-capitalize mr-5">
                    <div class="row">
                        <div class="col-5">
                            <h1 class="d-inline-block fw-700">wedding look</h1>
                ...
                <div class="container mt-5">
                    ...
                    <h6 class="fw-normal">This Package is for Standing Wedding Reception</h6>
                    <p class="m-0">Entrance Area</p>
                    <ul class="list-unstyled">
                        <li>- 2 Standing Angpaw</li>
                        <li>- Welcome Signage</li>
                        <li>- 2 Standing Photo Galleries</li>
                    </ul>

                    <p class="m-0">Bride & Groom Entrance:</p>
                    <ul class="list-unstyled">
                        <li>- Flower Gate</li>
                        <li>- Procession Carpet</li>
