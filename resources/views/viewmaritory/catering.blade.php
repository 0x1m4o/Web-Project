        ...
        <div class="row">
            <div class="col-8">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/img/carouselcatering.png" class="d-block w-100" alt="...">
                        </div>
                ...
                <div class="container mt-5 text-capitalize mr-5">
                    <div class="row">
                        <div class="col-5">
                            <h1 class="d-inline-block fw-700">garuda katering</h1>
                        ...
                        <div class="col-4 mt-3">
                            <a class="d-inline-block mx-3 kategori1 text-decoration-none text-white" href="">
                                <p class="text-capitalize">katering</p>
                            </a>
                    ...
                    <div class="row">
                        <div class="col-5">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class=" profile">
                                        <h6 class="text-capitalize"> garuda katering</h6>
                                        <p class="">online</p>
                                    </div>
                                </div>
            ...
            <div class="container col-4 mt-5">
                ...
                <button class="button2 mt-4 mx-4">
                    <div class="container text-capitalize mt-2">
                        ...
                        <p class="m-0" style="float: left; width: 50%; text-align: right; color:#49516F; font-weight:600">Rp 100.000.,00</p>
                        <p class="mt-2" style="float: left; width: 50%; text-align: left; color:#49516F; font-weight:400">minimum pemesanan </p>
                        <p class="mt-2" style="float: left; width: 50%; text-align: right; color:#49516F; font-weight:600">100</p>
