        ...
        <div class="row">
            <div class="col-8">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="/img/carouselwo.png" class="d-block w-100" alt="...">
                        </div>
                ...
                <div class="container mt-5 text-capitalize mr-5">
                    <div class="row mb-2">
                        <div class="col-4">
                            <h2 class="d-inline-block fw-700">jasmine WO</h2>
            ...
            <div class="dropdown">
                ...
                <button class="button1 mt-4 mx-4 border-0 border-0 shadow">
