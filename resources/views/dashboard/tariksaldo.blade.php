                        ...
                        <div class="pembayaran-nabung d-flex justify-content-between">
                            ...
                            <div class="direct-debit-mandiri" style="margin-top: 40px;text-align: end;">
                                <select id="debit" style="width: 217px; height: 43px;border-radius: 12px; border: none;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); padding: 5px;">
                                  ...
                                  <a href="#" class="btn" style="background: linear-gradient(90deg, #093028 0%, #237A57 100%); color: white; font-weight: bold; margin-top: 70px; width: 123px; height: 38px;" role="button">Submit</a>
                            </div>
                        </div>
                    </div> 
                </div>
