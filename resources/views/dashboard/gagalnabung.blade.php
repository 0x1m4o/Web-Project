            ...
            <div class="row justify-content-around mt-3">
                <div class="col-10">
                    ...
                    <div class="d-flex align-items-center my-3">
                        ...
                        <div class="col-2 ms-auto mb-4">
                            <button class="btn bg-white l px-4 py-2 fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);color: #49516F;border-radius:20px;">Salin</button>
                            {{-- Modal --}}
                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h6 class="modal-title text-center" id="exampleModalLabel">Pembayaran gagal dilakukan, silahkan lakukan 
                                            pembayaran sebelum  batas waktu berakhir</h6>
                                        </div>
                                        <div class="modal-body mx-auto">
                                            <i class="bi bi-x-circle text-danger" style="font-size: 5rem"></i>
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary d-block mx-auto" data-bs-dismiss="modal" style="background: linear-gradient(90deg, #093028 0%, #237A57 100%);">Tutup</button>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <a href="/nabung" class="text-center text-decoration-none fw-bold bg-white py-2 mb-3 mx-auto" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);
