...
<nav class="navbar navbar-expand-lg d-flex align-items-center" style="background: #1e6f5c">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-start">
            <button class="nav-btn navbar-toggler" type="button" data-bs-toggle="offcanvas"
    ...
    <div id="navbarSupportedContent" class="d-flex justify-content-end navbar-collapse offcanvas-end d-none">
        <a class="btn btn-light mx-1" style="color: #fdb662; background: white; border: none;" role="button"
            href="/login">Masuk</a>

        <a class="btn btn-light mx-1" style="background: #fdb662; color: white; border: none;" role="button"
