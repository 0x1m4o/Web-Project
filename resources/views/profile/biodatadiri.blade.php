    ...
    <div class="row">
        ...
        <div class="col-9">
            <div class="container" style="margin-top: 60px;border-radius: 10px;background: white;">
                ...
                <div class="row p-5">
                    <div class="col-4">
                        <div class="wrap-profile border" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                            <div class="d-flex justify-content-center">
                                <img src="/img/cecan.png" class="card-img-top p-3 m-auto" style="width:250px; height:250px">
                            </div>
                            <div class="card-body text-center mb-3">
                                <button class="pilih" style="border-radius:10px">Pilih Foto</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-8">
