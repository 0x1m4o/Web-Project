                    ...
                    <div class="row p-5">
                        <div class="col-4">
                            <div class="card" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                                <img src="{{ auth()->user()->avatar }}" class="card-img-top p-3  m-auto"
                                    style="width: 250px;">
                        ...
                        <div class="col-8">
                            <div class="container-fluid" style="border-bottom: 1px solid grey;">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-1">
                                        <i class="bi bi-pencil-fill fs-4" style="cursor: pointer" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5 fw-bold" id="staticBackdropLabel">Ubah
                                                            Biodata Diri</h1>
                                                        ...
                                                        <form method="post" action="{{ route('update.biodata') }}">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn"
                                                                    style="background: linear-gradient(90deg, #093028 0%, #237A57 100%); color: white ">Simpan</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                            ...
                            <div class="container-fluid mt-3" style="border-bottom: 1px solid grey;">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-1">
                                        <i class="bi bi-pencil-fill fs-4" style="cursor: pointer" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdropkontak"></i>
                                        <div class="modal fade" id="staticBackdropkontak" data-bs-backdrop="static"
                                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                            ...
                            <div class="container-fluid mt-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-1">
                                        <i class="bi bi-pencil-fill fs-4" style="cursor: pointer" data-bs-toggle="modal"
                                            data-bs-target="#staticBackdropsandi"></i>
                                        <div class="modal fade" id="staticBackdropsandi" data-bs-backdrop="static"
                                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        @if (Str::length(auth()->user()->password) == 10)
                                                            <p>Jika Anda Login menggunakan Google gunakan default password
                                                                berikut : <strong>{{ auth()->user()->password }}</strong>
                                                            </p>
                                                        @else
                                                            <p></p>
                                                        @endif
                                                        <form method="post" action="{{ route('update.password') }}">
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label for="current_password" class="form-label">Kata
                                                                ...
                                                                <span
                                                                    ...
                                                                    <i class="bi bi-eye-slash" id="togglePasswordcp"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <input id="new_password" type="password"
                                                                        ...
                                                                        value="" style="width: 95%; border: none">
                                                                    <i class="bi bi-eye-slash" id="togglePasswordnp"
                                                                        style="cursor: pointer"></i>
                                                                </span>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="confirm_password"
                                                                    class="form-label">Konfirmasi Kata Sandi Baru</label>
                                                                <span
                                                                    class="d-flex align-items-center justify-content-between form-control">
                                                                    <input id="confirm_password" type="password"
                                                                        ...
                                                                        aria-describedby="emailHelp" value=""
                                                                        style="width: 95%; border: none">
                                                                    <i class="bi bi-eye-slash" id="togglePasswordcfm"
                                                                        style="cursor: pointer"></i>
                                                                </span>
                                                            </div>
                                                            <div class="modal-footer d-flex justify-content-between">
                                                                <a href="{{ route('password.request') }}"
                                                                    class="text-start text-decoration-none text-secondary"
