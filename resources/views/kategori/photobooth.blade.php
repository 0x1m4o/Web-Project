...
<div class="content" style="background-color:#E5E5E5;">
    <div class="container navbar navbar-expand-lg text-capitalizes category-section mt-4" id="kategori">
        <button onclick="window.location.href='/kategori-perhiasan'" class="btn text-secondary text-capitalize category">
            <img src="/img/perhiasan.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">perhiasan</p>
        </button>
        <button onclick="window.location.href='/kategori-mc'" class="btn text-secondary text-capitalize category">
            <img src="/img/mc.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">MC</p>
        </button>
        <button onclick="window.location.href='/kategori-undangan'" class="btn text-secondary text-capitalize category">
            <img src="/img/undangan.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">undangan</p>
        </button>
        <button onclick="window.location.href='/kategori-weddingp'" class="btn text-secondary text-capitalize category">
            <img src="/img/wedding.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">wedding planner</p>
        </button>
        <button onclick="window.location.href='/kategori-honeymoon'" class="btn text-secondary text-capitalize category">
            <img src="/img/honeymoon.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">honey moon</p>
        </button>
        <button onclick="window.location.href='/kategori-photobooth'" class="btn text-secondary text-capitalize category aktif">
            <img src="/img/photo.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">photo booth</p>
        </button>
        <button onclick="window.location.href='/kategori-koreografi'" class="btn text-secondary text-capitalize category">
            <img src="/img/koreografi.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">koreografi</p>
        </button>
        <button onclick="window.location.href='/kategori-seserahan'" class="btn text-secondary text-capitalize category">
            <img src="/img/seserahan.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">seserahan</p>
        </button>
        <button onclick="window.location.href='/kategori-lainnya'" class="btn text-secondary text-capitalize category mx-2">
            <img src="/img/lainnya.png" alt="" class='ms-1' />
            <p class="d-inline-block p-1 mb-0 text-dark">lainnya</p>
        </button>

        <div class="dropdown dropdown-hover">
            <button type="button" class="dropdown-toggle text-capitalize view" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="container px-5 nav-filter d-flex justify-content-between" id="filter">
        ...
        <div class="d-flex justify-content-start">
                ...
                <div class="dropdown-menu dropdown-menu-center">
                    <div class="container p-3 " style="width: 352px;">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <input class="bts-harga text-secondary text-center" type="text" name="" id="minimal" value="Minimal" style="width: 45%">
                            <input class="bts-harga text-secondary text-center" type="text" name="" id="minimal" value="Maksimal" style="width: 45%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown dropdown-hover">
                <a href="" class="btn btn-white border border-1 mx-2 bg-white" style="box-shadow: 1px 2px 2px rgba(0, 0, 0, 0.149)">
    ...
    <div class="container row m-auto">
        <div class="col-sm-6 col-md-4 col-lg-3 ">
            <a class="text-decoration-none" href="/viewmaritory/photobooth">
