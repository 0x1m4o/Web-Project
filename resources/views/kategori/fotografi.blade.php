...
<div class="content" style="background-color:#E5E5E5;">
    <div class="container navbar navbar-expand-lg text-capitalizes category-section mt-4" id="kategori">
        ...
        <button onclick="window.location.href='/kategori-fotografi'" class="btn text-secondary text-capitalize category aktif">
            ...
            <a class="text-decoration-none" href="/view-fotografi">
                <div class="card card-kategori">
                    ...
                    <div class="card-body ms-2 mt-2">
                        ...
                        <h5 class="card-title fw-bold">Khayra Photography</h5>
