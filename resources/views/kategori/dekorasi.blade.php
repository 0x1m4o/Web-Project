...
<div class="content" style="background-color:#E5E5E5;">
    <div class="container navbar navbar-expand-lg text-capitalizes category-section mt-4" id="kategori">
        ...
        <button onclick="window.location.href='/kategori-dekorasi'" class="btn text-secondary text-capitalize category aktif">
        ...
        <button onclick="window.location.href='/kategori-fotografi'" class="btn text-secondary text-capitalize category">
    ...
    <div class="container px-5 nav-filter d-flex justify-content-between" id="filter">
        ...
        <div class="d-flex justify-content-start">
            ...
            <div class="dropdown dropdown-hover">
                <a href="" class="btn btn-white border border-1 mx-2 bg-white" style="box-shadow: 1px 2px 2px rgba(0, 0, 0, 0.149)"><iconify-icon icon="akar-icons:arrow-up-down"></iconify-icon>
                    <span class="ms-2 dropdown-toggle"></span></a>
    ...
    <div class="container row m-auto">
        <div class="col-sm-6 col-md-4 col-lg-3 ">
            <a class="text-decoration-none" href="/view-dekorasi">
                <div class="card card-kategori">
                    <img src="/img/carouseldekor.png" class="card-img-top" alt="..." />
                    <div class="card-body ms-2 mt-2">
                        <p class="stars">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                        </p>
                        <h5 class="card-title fw-bold" style="color: #49516f;"> Paket Panggung Salju</h5>
                        <p class="card-text mb-1" style="color: #ba9543">Rp 10.000.000</p>
                        <p class="card-text" style="color: #49516f;">
