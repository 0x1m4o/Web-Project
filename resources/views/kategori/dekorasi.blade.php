...
@section('content')
    ...
    <div class="content" style="background-color:#E5E5E5;">
        <div class="container navbar navbar-expand-lg text-capitalizes category-section mt-4" id="kategori">
            ...
            <button onclick="window.location.href='/kategori-dekorasi'"
                class="btn text-secondary text-capitalize category aktif">
            ...
            <button onclick="window.location.href='/kategori-souvenir'"
                class="btn text-secondary text-capitalize category mx-2">
