...
<div class="content" style="background-color:#E5E5E5;">
    <div class="container navbar navbar-expand-lg text-capitalizes category-section mt-4" id="kategori">
        ...
        <button onclick="window.location.href='/kategori-seserahan'" class="btn text-secondary text-capitalize category aktif">
    ...
    <div class="container row m-auto">
        <div class="col-sm-6 col-md-4 col-lg-3 ">
            <a class="text-decoration-none" href="/viewmaritory/seserahan">
