...
<div class="content" style="background-color: background: #E5E5E5;">
    <div class="container navbar navbar-expand-lg text-capitalizes category-section" id="kategori" >
        ...
        <div class="dropdown dropdown-hover">
            <button
            type="button"
            class="dropdown-toggle text-capitalize view"
            ...
            <div class="container dropdown-menu drop mt-3">
    ...
    <div class="d-flex justify-content-start">
        <div class="dropdown dropdown-hover">
            <a
            href="#"
            class="btn btn-white border border-1 mx-2 dropdown-toggle"
        ...
        <div class="dropdown dropdown-hover">
            <a
            href=""
            class="btn btn-white border border-1 mx-2"
            style="box-shadow: 1px 2px 2px rgba(0, 0, 0, 0.149)"
