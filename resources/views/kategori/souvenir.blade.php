...
<div class="content" style="background-color:#E5E5E5;">
    <div class="container navbar navbar-expand-lg text-capitalizes category-section mt-4" id="kategori">
        ...
        <button onclick="window.location.href='/kategori-souvenir'" class="btn text-secondary text-capitalize category aktif mx-2">
    ...
    <div class="container row m-auto">
        <div class="col-sm-6 col-md-4 col-lg-3 ">
            <a class="text-decoration-none" href="/view-souvenir">
                <div class="card card-kategori">
                    <img src="/img/carouselsouvenir.png" class="card-img-top" alt="..." />
                    <div class="card-body ms-2 mt-2">
                        <p class="stars">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                        </p>
                        <h5 class="card-title fw-bold">Mini Cactus Bags</h5>
