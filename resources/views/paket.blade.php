...
<style>
    ...
    <div class="container my-4" style="background: white;padding: 20px 0 10px 20px;border-radius: 20px;">
        <span style="width: 40px; height: 40px; background: white;display: inline-flex;align-items: center; justify-content: center; cursor: pointer;border-radius: 50%;box-shadow: -1px 2px 12px 4px rgba(17, 17, 26, 0.18);">
        ...
        <div class="row container my-4" style="display: flex;justify-content: center; align-content:space-between;">
            <div class="col-sm-4" style="padding-top: 20px;background: white; width: 400px; height: 210px;border-radius: 20px;margin-right: 15px;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);display: flex;justify-content: center;align-content:space-between;">
                <span>
                    ...
                    <button class="btn" style="background: #979797;color: white;">Pilih Sekarang</button>
                </span>
            ...
            <div class="col-sm-4" style="padding-top: 20px;background: white; width: 400px; height: 210px;border-radius: 20px;margin-right: 15px;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);display: flex;justify-content: center;align-content:space-between;">
                <span>
                    ...
                    <button class="btn" style="background: #BA9543;color: white;">Pilih Sekarang</button>
                </span>
            ...
            <div class="col-sm-4" style="padding-top: 20px;background: white; width: 400px; height: 210px;border-radius: 20px;margin-right: 15px;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);display: flex;justify-content: center;align-content:space-between;">
                <span>
                    ...
                    <p style="color: #237A57;">Paket pernikahan dan bulan madu terbaik yang kamu impikan</p>
