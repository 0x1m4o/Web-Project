...
<div class="content" style="background-color:#E5E5E5;">
    ...
    <div class="container px-5 nav-filter d-flex justify-content-between" id="filter">
        <div>
            <a href="/disekitarsaya" class="text-decoration-none p-2 me-2 ">Di sekitar saya</a>
            <a href="/terbaru" class="text-decoration-none p-2">Terbaru</a>
            <a href="/populer" class="text-decoration-none aktif p-2">Populer</a>
            <a href="/spesialoffer" class="text-decoration-none p-2">Special Offer!</a>
        </div>
