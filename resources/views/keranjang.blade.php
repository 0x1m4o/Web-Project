...
<div class="container keranjang-container p-3 mt-5 bg-white" style="width: 100%;border-radius:12px;">
    ...
    <div class="keranjang-body">
        <div class="form-check jcs">
            <input class="form-check-input mb-1 me-3 my-3" type="checkbox" value="" id="checkAll" name="selectall" autocomplete="off" onclick="eventCheckBoxAll()" />
        ...
        <div class="form-check jcs">
            ...
            <div class="row">
                <div class="d-flex">
                    ...
                    <h6 class="text-center keranjang-kategori p-1 px-2 mb-2 d-flex align-items-center mb-3 my-4">Venue</h6>
                </div>
                <h6 class="title-label fw-semibold d-inline-block mb-4">Kota Jakarta</h6>
            </div>
        </div>
        ...
        <div class="form-check jcs">
            ...
            <div class="row">
                ...
                <h6 class="title-label fw-semibold d-inline-block mb-4">Kota Jakarta Selatan</h6>
            </div>
        </div>
        <div class="keranjang-konten d-flex justify-content-between mt-2">
            <div class="row">
    ...
    <div class="ringkasan mb-2" style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);border-radius: 10px;">
        <div class="row text-center title-label">
            ...
            <h6 class="fw-semibold"><span class="border-bottom px-5 mb-2">Total 3 Vendor </span></h6>
            <h6 class="fw-semibold mt-2">Total Harga</h6>
            <h6 class="fw-semibold">Rp. 400.000.000</h6>
        </div>
        <div class="btn-konfirmasi pt-0 jcc">
            <a class="btn btn-md text-white" href="#" role="button" style="background: linear-gradient(to right,rgba(9, 48, 40, 1),rgba(35, 122, 87, 1));">Konfirmasi</a>
        </div>
    </div>
</div>
<script>
