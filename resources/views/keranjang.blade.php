    ...
    <div class="container keranjang-container p-3 mt-5 bg-white" style="width: 100%;border-radius:12px;">
        ...
        <div class="keranjang-body">
            <div class="form-check jcs">
                <input class="form-check-input mb-1 me-3" type="checkbox" value="" id="checkAll" name="selectall"
                    autocomplete="off" onclick="eventCheckBoxAll()" />
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="konten-detail d-flex align-items-center">
                            <div class="form-check jcs">
                                <input class="form-check-input mb-1 me-3 checkallthis TheAesthetic" type="checkbox"
                                    value="" />
                            </div>
            ...
            <div class="keranjang-konten d-flex justify-content-between mt-2">
                <div class="row">
                    <div class="col-6">
                        <div class="konten-detail d-flex align-items-center">
                            <div class="form-check jcs">
                                <input class="form-check-input mb-1 me-3 checkallthis LanghamSCBD" type="checkbox"
                                    value="" />
                            </div>
