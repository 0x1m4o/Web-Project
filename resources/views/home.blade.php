...
@section('content')
    ...
    <div class="home" style="background-color: white">
        ...
        <div class="container" style="margin-top: 50px;">
            ...
            <div class="paket"
                style="background: rgba(204, 227, 216, 0.5);
        box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.25);padding: 10px;border-radius: 20px;display: flex;justify-content: center;align-content:space-between;margin-top: 50px;">
                ...
                <p style="margin: auto; font-size: 25px; width: 500px;text-align: center;">Pilih paket pernikahan yang
                    sesuai keinginanmu!</p>
                <a href="/paket" style="text-decoration: none;color: white; margin: auto;">
